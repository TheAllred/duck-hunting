...
function Header({ logo, link }: AppHeadProps) {
  return (
    <div className="top-header">
      ...
      <a href={link} className="userlink">
  ...
  return (
    <nav>
      <ul>
        ...
        <li>
          <a href="history.html">My Ducks</a>
        </li>
        <li>
...
function Welcome() {
  return (
    <div className="welcome">
      ...
      <p>
        Forget the fat lady! You're obsessed with the fat lady! Drive us out of
        here! God creates dinosaurs. God destroys dinosaurs. God creates Man.
        Man destroys God. Man creates Dinosaurs. This thing comes fully loaded.
...
function DuckFound({ duckNum, timesFound }: AppDuckProps) {
  return (
    <>
      ...
      <p>
        Duck #{duckNum} has been found {timesFound} times
      </p>
    </>
  );
}
...
function CreateAccntButton() {
  return <button className="create-accnt">Create Account</button>;
}
...
function Features() {
  return (
    <div className="features">
      ...
      <section>
        <img
          src="https://cdn.discordapp.com/attachments/1062411530605449246/1065059844672999566/trans-single-duck.png"
          alt="single duck"
        />
        <h3>Feature 1</h3>
        <p>
          Hey, take a look at the earthlings. Goodbye! Just my luck, no ice. You
          really think you can fly that thing? Is this my espresso machine?
      ...
      <section>
        ...
        <h3>Feature 2</h3>
        <p>
          Must go faster... go, go, go, go, go! Did he just throw my cat out of
          the window? God help us, we're in the hands of engineers. Life finds a
          way.
        </p>
      </section>
      <section>
        ...
        <h3>Feature 3</h3>
        <p>
          So you two dig up, dig up dinosaurs? They're using our own satellites
          against us. And the clock is ticking. Remind me to thank John for a
          lovely weekend. Forget the fat lady! You're obsessed with the fat lady
        </p>
      </section>
